...
`;
    ...
    const musicPlayerContent = `
        <div class="music-player">
            ...
            <div id="playlist">
                <h3>Playlist</h3>
                <ul>
                    <li data-src="/John Newman - Love Me Again.mp3">Love Me Again</li>
                    <li data-src="/Dominic Fike - Phone Numbers (Official Audio).mp3">Phone Numbers</li>
                    <li data-src="/American Authors - Hit It (Audio).mp3">Hit It</li>
                </ul>
            </div>
        </div>
    `;
    ...
    <div class="achievement">
        <img src="/codm.png" alt="Achievement 1">
    ...
    <div class="achievement">
        <img src="/predator-rank.png" alt="Achievement 2">
    ...
    <div class="achievement">
        <img src="/maxresdefault-removebg-preview.png" alt="Achievement 3">
        <img src="/maxresdefault__1_-removebg-preview.png" alt="Achievement 3">
